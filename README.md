...
**Purpose:** In order to measure the effects of allelic variation & gene knockout on seasonal/daily phenotypes in *O. nubilalis*, an efficient genotyping procedure is necessary. Multiplexed Amplicon-seq data were processed to determined genotypes (VCF) for both gene-editing target loci & known candidate modifer loci.
